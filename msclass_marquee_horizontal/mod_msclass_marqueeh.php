...
$wrapper_width = (int)$params->get('wrapper_width');
$wrapper_height = (int)$params->get('wrapper_height');
$logo_width = (int)$params->get('logo_width');
$logo_height = (int)$params->get('logo_height');
